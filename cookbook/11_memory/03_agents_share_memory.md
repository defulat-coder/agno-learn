...
|--------|------|------|
| `db` | `db` | 显式参数 |
| `description` | `'You are a helpful assistant that can chat with users'` | 显式参数 |
...
用户代码层                agno.agent 层
┌──────────────────┐    ┌──────────────────────────────────┐
│ 03_agents_share_me│    │ Agent._run / _arun               │
...
|------|---------|-----------------|---------|
| 1 | `description` | `'You are a helpful assistant that can chat with users'...` | 是 |
| 2 | `role` | 未设置 | 否 |
