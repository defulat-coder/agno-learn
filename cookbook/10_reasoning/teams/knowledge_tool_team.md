...
| 配置项 | 值 | 说明 |
|--------|------|------|
| `add_datetime_to_context` | `True` | Team 显式参数 |
...
| `model` | `OpenAIChat(id='gpt-4o')` | Team 显式参数 |
| `name` | `'Reasoning Finance Team'` | Team 显式参数 |
| `show_members_responses` | `True` | Team 显式参数 |
| `tools` | `[knowledge_tools]` | Team 显式参数 |
...
┌──────────────────┐    ┌──────────────────────────────────┐
│ knowledge_tool_tea│    │ Team.run / Team._arun            │
