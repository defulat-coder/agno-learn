...
| 配置项 | 值 | 说明 |
|--------|------|------|
| `description` | 'You are a search agent that helps users find the most relevant information using Baidu.' | `Agent(...)` |
...
┌──────────────────────┐         ┌────────────────────────────────┐
│ baidusearch_tools.py │  ──▶  │ Agent → get_run_messages → Model │
└──────────────────────┘         └────────────────────────────────┘
                                          │
                                          ▼
                                  ┌───────────────┐
...
```text
--- description ---
You are a search agent that helps users find the most relevant information using Baidu.
```
