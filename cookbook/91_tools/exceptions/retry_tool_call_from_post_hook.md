...
| `session_id` | 'retry_tool_call_from_post_hook_session' | `Agent(...)` |
| `db` | SqliteDb(session_table='retry_tool_call_from_post_hook_session'db_file='tmp/retry_tool_call_from_post_hook.db'…) | `Agent(...)` |
| `markdown` | True | `Agent(...)` |
...
┌──────────────────────┐         ┌────────────────────────────────┐
│ retry_tool_call_from_post_hook.py │  ──▶  │ Agent → get_run_messages → Model │
└──────────────────────┘         └────────────────────────────────┘
                                          │
                                          ▼
                                  ┌───────────────┐
