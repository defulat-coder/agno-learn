...
| 配置项 | 值 | 说明 |
|--------|------|------|
| `model` | OpenAIChat(id='gpt-5-mini'…) | `Agent(...)` |
| `instructions` | "Use tables to display data. Don't include any other text." | `Agent(...)` |
| `markdown` | True | `Agent(...)` |
...
┌──────────────────────┐         ┌────────────────────────────────┐
│ mlflow_via_autolog.py │  ──▶  │ Agent → get_run_messages → Model │
└──────────────────────┘         └────────────────────────────────┘
                                          │
                                          ▼
                                  ┌───────────────┐
