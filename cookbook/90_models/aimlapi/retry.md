...
> 源文件：`cookbook/90_models/aimlapi/retry.py`
...
| 配置项 | 值 | 说明 |
|--------|------|------|
| `model` | `AIMLAPI(id=wrong_model_id, retries=3, delay_between_retries=1, exponential_backoff=True)` | 显式参数 |
| `db` | `None` | 未设置 |
| `knowledge` | `None` | 未设置 |
| `tools` | `None` | 未设置 |
